    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        ...
        <h1><img src="{{asset('images/favicon.ico')}}" style="width: 40px;">&nbsp;&nbsp;<span><img src="{{asset('images/UBanner.png')}}" style="width: 120px;"></span></h1>
            <p>Login Form</p>
            <a class="btn btn-app" href="{{ route('staff') }}"><i class="fa fa-group"></i>Staff</a>
            <a class="btn btn-app" href="{{ route('alumni') }}"><i class="fa fa-graduation-cap"></i>Alumni Feedback Form</a>
        </section><br />
        <div class="separator">
