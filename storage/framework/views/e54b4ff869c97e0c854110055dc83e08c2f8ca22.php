...
<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
    <div class="x_title">
  <h2><small><a href="<?php echo e(route('boardDetail',$board->id)); ?>" class="fa fa-angle-double-left" >&nbsp;&nbsp;Licensure Exam Edit</a> </small></h2>
...
<form action="<?php echo e(route('updateBoard')); ?>" method="post" enctype="multipart/form-data" autocomplete="off" class="form-horizontal form-bordered">
        <?php echo e(csrf_field()); ?>

        <input type="text" value="<?php echo e($board->id); ?>" name="boardID" hidden>
    <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo e($board->supporting_doc); ?>" hidden>
        ...
        <div class="row form-group">
           <div class="col-md-5">
            ...
            <div class="col-md-5">
                ...
                <label>Year</label>
                <input type="text" value="<?php echo e($board->exam_year); ?>" id="exam_year" hidden>
          ...
          <div class="col-md-2">
              ...
              <input type="number" class="form-control" name="school_rank"  min="0" max="10"placeholder="ex. 1" value="<?php echo e($board->school_rank); ?>" required>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <tbody>
          <tr>
            <td class="ftaker-me"><input type="number" class="ftaker form-control" id="fpassed" name="fpassed" min="0" max="100"oninput="calculateSum()" value="<?php echo e($board->ftaker_passed); ?>" required></td>
            <td class="ftaker-me"><input type="number" class="ftaker form-control" name="ffailed" min="0" max="100" oninput="calculateSum()" value="<?php echo e($board->ftaker_failed); ?>" required></td>
            <td class="ftaker-me"><input type="number" class="ftaker form-control" name="fcon" min="0" max="100"oninput="calculateSum()" value="<?php echo e($board->ftaker_cond); ?>"required> </td>
            <td id="ftotal"></td>
            <td id="fpercent"></td>
            <td class="total-me"><input type="number" class="ttaker form-control" id="tpassed" name="tpassed" min="0" max="100" oninput="calculateSum()" value="<?php echo e($board->total_passed); ?>" required></td>
            <td class="total-me"><input type="number" class="ttaker form-control" name="tfailed" min="0" max="100" oninput="calculateSum()" value="<?php echo e($board->total_failed); ?>"required> </td>
            <td class="total-me"><input type="number" class="ttaker form-control" name="tcon" min="0" max="100" oninput="calculateSum()" value="<?php echo e($board->total_cond); ?>"required> </td>
            <td id="ttotal"></td>
            <td id="tpercent"></td>
            <td><input type="number" class="form-control" name="npasser" min="0" max="100" step=".01" style="font-size:13px;" value="<?php echo e($board->national_percent); ?>" required></td>
          </tr>
        </tbody>
      </table>
        </div>
  ...
  <div class="col-md-12 form-group">
    ...
    <table class="display" id="topTable" style="width:60%">
      ...
      <tbody>
        ...
        <input type="text" class="form-control" name="topID[]" value="<?php echo e($top->id); ?>" hidden>
        <?php $count++;
        echo '<tr>
          <td>'.$count.'.</td>' ?>
          <td><input type="text" class="form-control" name="top[]" value="<?php echo e($top->name); ?>"></td>
          <td><input type="number" min="0" max="10"class="form-control" name="rank[]" value="<?php echo e($top->rank); ?>"></td>
...
<div class="row mt-4">
    <div id="clasValidate" class=" col-sm-12 float-right">
      ...
      <a class="btn btn-danger" href="<?php echo e(route('boardDetail',$board->id)); ?>"> Back</a>
    </div>
    </div>
</form>
    </div>
...
<?php echo $__env->make('common.functions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/BoardExam\Resources/views/boardEdit.blade.php ENDPATH**/ ?>