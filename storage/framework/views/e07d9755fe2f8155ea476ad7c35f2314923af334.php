...
<script type="text/javascript">
 ...
 // program table
      ...
      var dataTable= $('#history_table').DataTable( {
        "ordering": false,
        "ajax": "<?php echo e(route('accred_stat_dtb')); ?>",
...
$('.alert').hide();
  //add
    $( "#add_status_form" ).submit(function( event ) {
        ...
        $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('addStatus')); ?>",
     ...
     $(document).on('click','.destroy',function(){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
          url:"<?php echo e(route('deleteStatus')); ?>",
          method:"POST",
          data:{
            id:id,
            _token:token
    ...
    $(document).on('click','.edit',function(){
        ...
        $.ajax({
          url:"<?php echo e(route('editStatus')); ?>",
          method:"POST",
          data:{
            id:id,
            _token:token
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/Accreditation\Resources/views/accred-status.blade.php ENDPATH**/ ?>