...
<div class="col-md-12 col-sm-12 ">
    ...
    <div class="x_title">
      ...
      <?php if(Auth::user()->hasPermission('create-board')): ?>
    ...
    <form class="mb-4" action="<?php echo e(route('boardfilterReport')); ?>" target="_blank" method="POST">
      <?php echo csrf_field(); ?> 
   <div class="row">
...
<div class="col-md-12 col-sm-12 ">
  ...
  <?php endif; ?>
<?php if(!empty(Session::get('success_modal')) && Session::get('success_modal') == 5): ?>
<script>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="<?php echo e(route('addBoardExam')); ?>" method="post" enctype="multipart/form-data" autocomplete="off" class="form-horizontal form-bordered" style="padding: 0px 8px 0px 16px;">
...
Swal.fire({
  ...
  <?php elseif(\Session::has('duplicate')): ?>
  <script>
  Swal.fire({
    icon: 'error',
    title: 'Oops...',
...
$.fn.dataTable.ext.search.push(
 ...
 var dataTable = $('#boardexam_table').DataTable( {
          ...
          "bSort" : false,
          "ordering": false,
          "ajax": "<?php echo e(route('boardexam_dtb')); ?>",
...
        buttons: [
 ...
 $('#min, #max, #examtype, #examonth, #examyear').change(function () {
	...
	var id = $(this).attr('awardid');
        ...
        if (result.isConfirmed) {
          $.ajax({
			  url:"<?php echo e(route('deleteBoard')); ?>",
			  method:"POST",
			  data:{
				id:id,
				_token:token
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/BoardExam\Resources/views/index.blade.php ENDPATH**/ ?>