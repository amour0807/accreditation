...
<div class="col-md-12 col-sm-12 ">
  ...
  <?php if(Auth::user()->hasPermission('create-student')): ?>
...
</div> <form class="mb-4" action="<?php echo e(route('userawardfilterReport')); ?>" target='_blank' method="POST">
	<?php echo csrf_field(); ?> 
	  ...
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	       ...
	       <form id="form" action="<?php echo e(route('addStudentAward')); ?>" method="post" enctype="multipart/form-data" autocomplete="off" id="studentForm" class="form-horizontal form-bordered" style="padding: 0px 8px 0px 16px;">
			...
			<span class="text-danger">* Required Fields</span><br>
		    	...
		    	<div class="form-group">
		        	<label><span class="text-danger">*</span><?php if(!Auth::user()->hasRole('admin')): ?><?php echo e($school->school_code); ?><?php endif; ?> Program:</label>

					<select class="form-control small" name="acad_prgram_id" required>
						 <option disabled selected value> -- --  </option>
						<?php $__currentLoopData = $acad_prog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					 	 <option value = '<?php echo e($aw->a_id); ?>'> <?php echo e($aw->acad_prog); ?>  </option>
					 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
		        </div>
...
<div class="modal fade " data-backdrop="static" id="success-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-danger" href="<?php echo e(route('userStudentAward')); ?>">Proceed to Dashboard</a>
	...
	$('#max').each(function() {
		...
		function( settings, data, dataIndex ) { 
		  ...
		  var dataTable= $('#awardtable').DataTable( {
				"ajax": "<?php echo e(route('userAward_dtb')); ?>", //view
				responsive: true,
          		"ordering": false,
			    dom: 'Blfrtip',
			  lengthMenu: [
...
$(document).on('click','.destroy',function(){
	var id = $(this).attr('awardid');
        ...
        if (result.isConfirmed) {
          $.ajax({
			  url:"<?php echo e(route('deleteAward')); ?>",
			  method:"POST",
			  data:{
				id:id,
				_token:token
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/Award\Resources/views/others/index.blade.php ENDPATH**/ ?>