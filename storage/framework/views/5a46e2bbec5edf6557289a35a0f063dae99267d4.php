...
<div class="col-md-12 col-sm-12 ">
    ...
    <div class="x_title">
      ...
      <?php if(Auth::user()->hasPermission('create-instaward')): ?>
    ...
    <form class="mb-4" action="<?php echo e(route('instawardfilterReport')); ?>" target="_blank"method="POST">
      <?php echo csrf_field(); ?> 
   <div class="row">
        <div class="col-md-6">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-danger" href="<?php echo e(route('instAward')); ?>">Cancel</a>
...
<?php echo $__env->make('common.inputVal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
    ...
    $( "#studentForm" ).submit(function( event ) {
        ...
        $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('addInstAward')); ?>",
...
$.fn.dataTable.ext.search.push(
 ...
 var dataTable = $('#instawardtable').DataTable( {
            "ajax": "<?php echo e(route('instaward_dtb',1)); ?>",
     ...
     $('#min, #max, #award, #scopes').change(function () {
       ...
       $(document).on('click','.destroy',function(){
        ...
        if (result.isConfirmed) {
          $.ajax({
          url:"<?php echo e(route('deleteInstAward')); ?>",
          method:"POST",
          data:{
            id:id,
            _token:token
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/Award\Resources/views/instAward.blade.php ENDPATH**/ ?>