...
<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
    <div class="x_title">
      <form class="mb-4" action="<?php echo e(route('filterReport')); ?>" method="POST">
        <?php echo csrf_field(); ?> 
...
$.fn.dataTable.ext.search.push(
 ...
 // program table
      ...
      var dataTable= $('#program_report_table').DataTable( {
        responsive: true,
        "ordering": false,
        "ajax": "<?php echo e(route('program_history_report_dtb')); ?>",
        "columns": [
            { "data": "school" },
            { "data": "program" },
            { "data": "accred_stat" },
...
// Event listener to the two range filtering inputs AND THE status to redraw on input
  ...
  $( "#addSchoolForm" ).submit(function( event ) {
      ...
      $.ajax({
        url:"<?php echo e(route('filterReport')); ?>",
        method:"POST",
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/Accreditation\Resources/views/history-reports.blade.php ENDPATH**/ ?>