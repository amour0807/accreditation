...
<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
	  <div class="x_content">
		  <div class="row">
			  <div class="col-sm-12">
			  <form class="mb-4" action="<?php echo e(route('filterReport')); ?>" target="_blank" method="POST">
			  <?php echo csrf_field(); ?> 
...
$.fn.dataTable.ext.search.push(
   ...
   // program table
        ...
        var dataTable= $('#program_report_table').DataTable( {
			responsive: true,
			"ordering": false,
	        "ajax": "<?php echo e(route('program_report_dtb')); ?>",
	        "columns": [
	            { "data": "school" },
	            { "data": "program" },
	            { "data": "accred_stat" },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/Accreditation\Resources/views/accreditation-report.blade.php ENDPATH**/ ?>