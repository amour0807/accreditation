...
<script type="text/javascript">
 ...
 // program table
      ...
      var dataTable= $('#schooldept_table').DataTable( {
        "ordering": false,
        "ajax": "<?php echo e(route('school_dept_dtb')); ?>",
...
$('.alert').hide();
  ...
  var token = $("input[name='_token']").val();
     ...
     $(document).on('click','.destroy',function(){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
          url:"<?php echo e(route('deleteSchoolDept')); ?>",
          method:"POST",
          data:{
            id:id,
            _token:token
    ...
    $(document).on('click','.edit',function(){
        ...
        $.ajax({
          url:"<?php echo e(route('editSchoolDept')); ?>",
          method:"POST",
          data:{
            id:id,
            _token:token
    ...
    $( "#edit_schooldept_form" ).submit(function( event ) {
        event.preventDefault();
        $.ajax({
          url:"<?php echo e(route('updateSchoolDept')); ?>",
          method:"POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Accreditation\Modules/Accreditation\Resources/views/school-index.blade.php ENDPATH**/ ?>