...
<div class="col-md-12 col-sm-12 ">
  ...
  @if(Auth::user()->hasPermission('create-graduate'))
...
</div> <form class="mb-4" action="{{route('graduatefilterReport')}}" target="_blank" method="POST">
	@csrf 
    <div class="row">
    	<div class="col-md-8">
    	</div>
