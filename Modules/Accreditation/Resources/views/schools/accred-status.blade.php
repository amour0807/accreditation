...
<div class="mb-5">
	<h1 class="float-left">Accreditation Status</h1>
  <hr>
...
<script type="text/javascript">
   ...
   // program table
        ...
        var dataTable= $('#history_table').DataTable( {
          ...
          "ajax": "{{route('userAccred_stat_dtb')}}",
